...
@TeleOp
public class Manual_Complete_Red extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        RobotLog.ii("Servo initial Left Position", "%5.2f", left_servo.getPosition());
        RobotLog.ii("Servo initial Right Position", "%5.2f", right_servo.getPosition());
